...
class CircleChanger(object):
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        t_index = random.randrange(3, 16)
        self.circle.outline_thickness = t_index
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        newpoint = rg.Point.halfway_to(self.circle.center,
                             other_circle_changer.circle.center)
        x = newpoint.x
        y = newpoint.y
        radius = newpoint.get_distance_from(other_circle_changer.circle.center)
        fill_color = 'red'
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.startcolor
